...
export declare class Wallet implements WalletProvider {
    ...
    private init;
    loadSession: (preferredNetwork?: string | number) => Promise<WalletSession | undefined>;
    connect: (options?: ConnectOptions) => Promise<ConnectDetails>;
...
export declare const initWallet: (network?: string | number, config?: Partial<ProviderConfig>) => Promise<Wallet>;
