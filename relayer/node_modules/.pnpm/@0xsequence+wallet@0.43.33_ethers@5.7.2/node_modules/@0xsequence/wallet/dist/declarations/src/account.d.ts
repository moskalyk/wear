...
export declare class Account extends Signer {
    ...
    getProvider(chainId?: number): Promise<providers.JsonRpcProvider | undefined>;
    ...
    getFeeOptions(transaction: utils.Deferrable<Transactionish>, chainId?: ChainIdLike, allSigners?: boolean): Promise<{
        options: FeeOption[];
        quote?: FeeQuote;
    }>;
    sendTransaction(dtransactionish: utils.Deferrable<Transactionish>, chainId?: ChainIdLike, allSigners?: boolean, quote?: FeeQuote, callback?: SignedTransactionsCallback): Promise<TransactionResponse>;
    sendTransactionBatch(transactions: utils.Deferrable<providers.TransactionRequest[] | Transaction[]>, chainId?: ChainIdLike, allSigners?: boolean, quote?: FeeQuote, callback?: SignedTransactionsCallback): Promise<TransactionResponse>;
    signTransactions(dtransactionish: utils.Deferrable<Transactionish>, chainId?: ChainIdLike, allSigners?: boolean): Promise<SignedTransactions>;
    prependConfigUpdate(dtransactionish: utils.Deferrable<Transactionish>, chainId?: ChainIdLike, allSigners?: boolean, skipThresholdCheck?: boolean): Promise<Transactionish>;
