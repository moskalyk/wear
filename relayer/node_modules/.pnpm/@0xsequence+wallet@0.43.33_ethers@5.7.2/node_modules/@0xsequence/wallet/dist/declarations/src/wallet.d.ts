import { BytesLike, BigNumber, BigNumberish, Signer as AbstractSigner, providers, utils, TypedDataDomain, TypedDataField } from 'ethers';
...
export declare class Wallet extends Signer {
    ...
    getProvider(chainId?: number): Promise<providers.JsonRpcProvider>;
    ...
    sendTransaction(transaction: Deferrable<Transactionish>, chainId?: ChainIdLike, allSigners?: boolean, quote?: FeeQuote, callback?: SignedTransactionsCallback, waitForReceipt?: boolean): Promise<TransactionResponse>;
    sendTransactionBatch(transactions: Deferrable<TransactionRequest[] | Transaction[]>, chainId?: ChainIdLike, allSigners?: boolean, quote?: FeeQuote, callback?: SignedTransactionsCallback, waitForReceipt?: boolean): Promise<TransactionResponse>;
    ...
    updateConfig(config?: WalletConfig, nonce?: number, publish?: boolean, indexed?: boolean, quote?: FeeQuote, callback?: SignedTransactionsCallback, waitForReceipt?: boolean): Promise<[WalletConfig, TransactionResponse]>;
    publishConfig(indexed?: boolean, nonce?: number, requireFreshSigners?: string[], quote?: FeeQuote, callback?: SignedTransactionsCallback, waitForReceipt?: boolean): Promise<TransactionResponse>;
